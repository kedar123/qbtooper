...
{
    var h = $(window).height();
    $("#transactions").css('height', h - 425);
    $("#left").css('height', h - 240);
}
  ...
  wesabe.views.pages.accounts.prototype = {
    ...
    init: function() {
      ...
      wesabe.ready('wesabe.views.widgets.account-transactions', function() {
        if (self._hasLoadedTransactions == false) {
    ...
    setUpTransactionWidget: function() {
      ...
      self.transactions.fn('offset', self.offset);
